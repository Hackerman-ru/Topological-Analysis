...
TEST_CASE("FlatTree Add and Has") {
    FlatTree st(10);
...
TEST_CASE("FlatTree Cofacets With DifferentBranches") {
    FlatTree st(10);
    st.Add({1, 2}, 0);
    st.Add({0, 1}, 2);
    st.Add({0, 1, 2}, 1);
...
TEST_CASE("Stress Test: Large FlatTree") {
    FlatTree st(1000);
...
TEST_CASE("FlatTree basic operations") {
    FlatTree st(5);
